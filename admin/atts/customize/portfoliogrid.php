...
// -----------------------------------------
// semplice
// admin/atts/customize/portfoliogrid.php
// -----------------------------------------
		...
		'tabs' => array(
			'projects' => array(
				'project-management' => array(
					...
					'break'		 => '1',
					'class'		 => 'pg-projects',
					'help'		 => 'You can manage (change thumbnails, hide, order) your projects here.',
					'projects' => array(
						'title'				=> 'Projects',
						'hide-title'		=> true,
						'size'				=> 'span4',
						'offset'			=> false,
						'data-input-type' 	=> 'projects',
						'class'				=> 'admin-listen-handler',
						'data-handler'		=> 'portfoliogrid',
					),
				),
			),
			'options' => array(
