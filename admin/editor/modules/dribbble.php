	...
	class sm_dribbble {
		...
		public function output_editor($values, $id) {
			...
			if($media == 'curl') {
				...
				// vars
				$connect_button = '';
				$connect_message = 'You are not connected yet.';
				...
				// get masonry
				$this->output['html'] = semplice_masonry($id, $values['options'], $masonry_items, $hor_gutter, $ver_gutter, $this->is_editor, $values['script_execution']);
